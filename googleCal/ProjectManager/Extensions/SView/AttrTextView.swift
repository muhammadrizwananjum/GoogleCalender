...
class AttrTextView: UITextView {
    ...
    public func setText(text: String, withHashtagColor hashtagColor: UIColor, paramValue: [String], andCallBack callBack: @escaping (String, wordType) -> Void, normalFont: UIFont, hashTagFont: UIFont) {
        ...
        setAttrWithName(attrName: "ParamValue", wordPrefix: paramValue[0], color: hashtagColor, text: text, font: hashTagFont)
