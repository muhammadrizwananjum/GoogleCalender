...
open class SideMenuManager : NSObject {
    ...
    /// Duration of the remaining a@objc nimation when the menu is partially dismissed with gestures. Default is 0.35 seconds.
    open static var menuAnimationCompleteGestureDuration: Double = 0.35
    
    /// Amount to fade the e@objc @objc @objc @objc xis@objc ting v@objc iew controller when the menu is presented. Default is 0 for no fade. Set to 1 to fade completely.
