...
open class DatePickerDialog: UIView {
    ...
    public init(textColor: UIColor = UIColor.black,
                ...
                showCancelButton: Bool = true,
                 viewBGColor: UIColor = UIColor.white   ) {
    ...
    open func show(_ title: String,
                   doneButtonTitle: String = NSLocalizedString("Done", comment: "done button"),
                   cancelButtonTitle: String = NSLocalizedString("Cancel", comment: "cancel button"),
